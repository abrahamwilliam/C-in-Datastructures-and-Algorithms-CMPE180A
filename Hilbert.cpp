...
void multiply(const int n, double A[][MAX_SIZE], double B[][MAX_SIZE], double c[][MAX_SIZE]);
...
int main()
{
    ...
    do {
        ...
        if (sizeOfMatrix > 5 || sizeOfMatrix <= 0){
           cout << "Done! " << endl;
           return 0;
        }
        ...
        cout << "  " << endl;
        multiply(sizeOfMatrix, A, Ain, Result);

        //result matrix contains the inverted hm * hilbert matrix

        double Ain1[MAX_SIZE][MAX_SIZE];
        
        cout << "  " << endl;
        cout << " Inverse Hilbert matrix inverted:" << endl;
        cout << "  " << endl;

        invert(sizeOfMatrix, Ain, Ain1);
      ...
      //  cout << "Please enter the size of the hilbert matrix(1-5) --" << endl;
        cin >> sizeOfMatrix;

    } while (sizeOfMatrix < 5 || sizeOfMatrix != 0);
    cout << "" << endl;
    cout << "Done !  " << endl;
...
void multiply(const int sizeOfMatrix, double A[][MAX_SIZE], double B[][MAX_SIZE], double Result[][MAX_SIZE])
{
