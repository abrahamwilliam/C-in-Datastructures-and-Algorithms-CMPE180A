...
const string BOUNDARY_FILE_NAME = "C:\\Users\\lenovo\\Desktop\\boundary-data.csv";
const string CITY_FILE_NAME     = "C:\\Users\\lenovo\\Desktop\\city-data.csv";
...
int main()
{
    ...
    input.open("C:\\Users\\lenovo\\Desktop\\boundary-data.csv");
    if (input.fail())
    {
  ...
  do_boundary(input, list);
    ...
    input.open("C:\\Users\\lenovo\\Desktop\\city-data.csv");
    if (input.fail())
    {
...
void do_boundary(ifstream& input, SortedLinkedList& list)
{
    ...
    //    cout<<" th value for latitude in eof is "<<coordinate.get_latitude()<<endl;
     //    cout<<" th value for longitude in eof is "<<coordinate.get_longitude()<<endl;
