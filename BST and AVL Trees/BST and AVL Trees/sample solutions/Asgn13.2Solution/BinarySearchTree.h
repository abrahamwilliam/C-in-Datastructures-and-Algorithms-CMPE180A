...
private:
     ...
     */
    BinaryNode *findMin(BinaryNode *ptr);
     ...
     *         or nullptr if the subtree is empty.
     */
    BinaryNode *findMax(BinaryNode *ptr);
     ...
     * @return true if and only if data is in the tree.
     */
    bool contains(const long data, BinaryNode *ptr);
};
