	...
	Door hideCar()
	{
	  ...
	  //  cout << "the car has been hidden in the door" << carHiddenDoor << endl;
	...
	Door makeFirstChoice()
	{
	   ...
	   // cout << "the door that has been choosen by me" << myFirstChoice << endl;
	...
	void simulate(Door SIMULATION_COUNT)
	{
	    ...
	    for (Door i = 0; i < SIMULATION_COUNT; i++) {
	        ...
	        if (firstChoosenDoor == hiddenDoor) {
	            win1++;
	            if(i>=10){
	            	cout<<i<<"   "<<"    "<<hiddenDoor <<"    "<<"    "<<firstChoosenDoor<<"    "<<"         "<<wrongDoorByMonty<<"     "<<"        "<<secondChoosendoor<<"    "<<"       "<<" Yes"<<"    "<<"    "<<"    "<<"  "<<endl;
				}else{
					cout<<" "<<i<<"   "<<"    "<<hiddenDoor <<"    "<<"    "<<firstChoosenDoor<<"    "<<"         "<<wrongDoorByMonty<<"     "<<"        "<<secondChoosendoor<<"    "<<"       "<<" Yes"<<"    "<<"    "<<"    "<<"  "<<endl;
				}
