	...
	{   
	    ...
	    cin>>sizeOfMatrix;
	    if(sizeOfMatrix > 5) return 0;
	    double A[MAX_SIZE][MAX_SIZE];
	    cout<<"Hilbert matrix is below --"<<endl;
	    cout<<setw(10);
	    ...
	    cout<<endl;
	    cout<<"Please find the inverted Hilbert matrix below-- "<<endl;
	    cout<<endl;        
	    ...
	    cout<<endl;
	    cout<<"Hilbert matrix * Inverse is below "<<endl;
	    cout<<endl;
	    multiply(sizeOfMatrix, A, Ain);
	    return 0;
	}
	
	
	void multiply(const int sizeOfMatrix, double A[][MAX_SIZE], double B[][MAX_SIZE]){
		
		 double temp=0.0;
	    double Result[sizeOfMatrix][sizeOfMatrix]={};
	    int count=0;
	   for(int i=0; i<sizeOfMatrix; i++){                
	     for(int j=0; j<sizeOfMatrix; j++){                           
